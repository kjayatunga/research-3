...
This phase was focused on analysing the fluid dynamics involved in galloping and how it can be manipulated to get an optimum power output. With existing literature it was clear that the induced lift on a galloping body, will increase until it reaches the shear layer re-attachment. Therefore, it was hypothesised that the cross section could be further optimised to get a higher power output by delaying the shear layer reattachment. This was done by tapering away the afterbody of the square cross section. 

The data of this phase is currently being processed and is expected to be presented during the pre-submission seminar. 
