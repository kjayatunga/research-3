...
set output "displacement_high_pi_1.eps"
set xtics nomirror
set ytics nomirror
set ytics("0.5" 0.5,"1.0" 1.0,"1.5" 1.5,"2.0"2)
set xtics (0.2,0.4,0.6,0.8,1)
set xtics format " " set ytics ("1.0" 1,"2.0" 2,"3.0" 3)
plot [0:1][0:2] "10" u 2:7 w p pt 2, "100"   u 2:7 w p pt 13, "500"  u 2:7 w p pt 1,"1000"  u 2:7 w p pt 8
#######################################
reset
unset key
unset ylabel
set term postscript enhanced portrait monochrome size 12cm,6cm "Times-roman" 12
set output "velocity_high_pi_1.eps"
...
unset ylabel 
set term postscript enhanced portrait monochrome size 12cm,6cm "Times-roman" 12
set output "mean_power_high_pi_1.eps"
