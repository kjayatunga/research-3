...
%  
 ...
 \caption{Mean power as a function of \massdamp obtained using QSS assumption. Sub-figure (a) at high \massstiff; data presented at four different combined mass-stiffness levels.\ $\massstiff=10 \ (\mstar=20,\ \ustar=40)$ \ ($\times$),\ $\massstiff=100 \ (\mstar=80,\ \ustar=50) \ (+)$,\ $\massstiff=500 \ (\mstar=220,\ \ustar=60)$ \ (\ding{117}) and \ $\massstiff=1000 \ (\mstar=400,\ \ustar=40) \ (\triangle)$. Sub-figure (b) at low \ \massstiff \ ; data presented at $\massstiff=10 \ (\times)$, \  $\massstiff=0.1 \ $ (\ding{117}), and  \  $\massstiff=0.01 \ \ (\triangle)$.}
    \label{fig:high_pi_1}
\end{figure}
