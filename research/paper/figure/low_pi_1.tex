...
%  
  ...
  \caption{Mean power as a function of \massdamp obtained using QSS assumption data at high and low \ \massstiff.  Data presented at $\massstiff=100 \ (\times) \ \mstar=130 (+)$, \  $\massstiff=0.1 \ \mstar=2$ (\ding{117}), \  $\massstiff=0.1 \ \mstar=20 \ (\triangle)$ and  $\massstiff=0.1 \ \mstar=50 \ (*)$. The mass ratio does not have an effect on \massstiff even at low \massstiff}
    \label{fig:low_pi_1}
\end{figure}
