...
Even though the quasi-steady model does not accurately predict the power extracted, it does predict the parameter values at which maximum power occurs reasonably well, and is therefore a valuable design tool for energy extraction devices based on fluid-elastic galloping.
