...
In this paper, power transfer of an elastically mounted body under the influence of fluid-elastic galloping is analysed.

The quasi-steady state model equations are first analysed to find suitable governing parameters. It is shown that, as well as \reynoldsnumber, the system is a function of three dimensionless groups: a combined mass-stiffness parameter \massstiff; a combined mass-damping parameter, \massdamp; and mass ratio \mstar \KJ{Is mass ratio now a dimensionless group?}.

Data obtained by numerically integrating the quasi-steady state equations show that for high values of \massstiff, the  power extracted from the flow is a function of \massdamp\ only. For low values of \massstiff, the power extracted is still a strong function of \massdamp, but is also a weak function of \massstiff. For all the cases tested, the power extracted was independent of the value of \mstar. 

These results are then compared to results of direct numerical simulations.  It is found that \massstiff\ has a much stronger impact on the power extracted than predicted by the quasi-steady state model. The error is shown to be an inverse funtion of \massstiff. The failure of the quasi-steady state model at low \massstiff\ is hypothesied to be due to the stronger influence of vortex shedding, which is not accounted for in the quasi-steady model. Spectral analysis of the DNS cases at low \massstiff\ shows a significant response at the vortex shedding frequency. The strength of the vortex shedding response is also shown to be an inverse function of \massstiff. 

Even though the quasi-steady model does not accurately predict the power extracted, it does predict the parameter values at which maximum power transfer occurs reasonably well, and both the quasi-steady model and the direct numerical simulations show this value is basically independent of \massstiff.
