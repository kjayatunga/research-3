...
%   \input{../figure/collapsed_dta}
 ...
 \input{../figure/low_pi_1}
  ...
  From figure \ref{fig:high_pi_1} it could be seen that the collapse of the mean power and velocity amplitude are excellent, regardless of the combination of \ustar \ and \ \mstar \ being used. Thus $\massstiff \geq 10$  is defined high \massstiff \ and the rest as low \massstiff. As \massstiff \ reduces, at low \massstiff (Fig:\ref{fig:low_pi_1}), the power increases. However, figure \ref{fig:low_pi_1} shows that the mean power does not change if \massstiff \ is kept constant and \mstar \ is varied. This particular region could not be captured in the DNS results as the vortex shedding is much stronger and overcomes the galloping signal indicating that the QSS hypothesis deviates from the actual behaviour of the system at low \massstiff.
