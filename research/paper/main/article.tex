...
The flow filed data at the region of maximum power at different \massstiff \ presented in figure \ref{fig:flow_vis}, shows a clear wavelength of the wake as the \massstiff \ is increased. Qualitatively, the flow filed shows that at high \massstiff \ vortex shedding is superimposed over the path of motion of the cylinder. It shows a decrease in amplitude at low \massstiff, which maybe due to the high level non-linear interaction between shedding and galloping. However, the vorticity plots further explains the influence of vortex shedding on galloping, and therefore the discrepancy of power at low \massstiff. 
