...
\rwtwo{The impact of \massstiff \ is indepndent of the impact of \mstar evthough \mstar is an independent parameter in equation \ref{eqn:eom_nondim_regroup_pi_1_pi_2}. Our results show that the system is essentially function of \massstiff and \massdamp only. This is because as shown in equation \ref{eqn:eom_nondim_regroup_pi_1_pi_2} \mstar only have an impact on the non-linear terms and velocity of the body is very high, which appears not to be the case of the parameters tested here.} 
