...
In this representation $\lambda$ represents the inverse time scale of the motion of the body due to the effect of long-time fluid dynamic forces (or forced due ot the induced velocity). This term could also be re-written and $\lambda$ could be expressed as 
...
This form clearly shows the significant parameters that influences the inverse time scale.  
