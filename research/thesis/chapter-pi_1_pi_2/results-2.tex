...
The lower boundary of \massstiff\ for the DNS results was limited $\massstiff=10$. This was due to the difficulty of obtaining a galloping signal through DNS simulations as \massdamp\ increases. As discussed in section \ref{subsec:freq-spectrum}, vortex shedding becomes more dominant and galloping becomes weaker as \massstiff\ reduces. This as \massdamp\ increases the galloping signal further weakens. Thus, the lower boundary of \massstiff\  was set where DNS data could be obtained across the range of \massdamp\ considered for power transfer ($\massdamp\ 015-0.8$). The ratio between \freqlin\ and \freqdns\ a good agreement in the rage of \massstiff\ considered. Thus, the expression formulated for the frequency of the system obtained using the newly formulated parameters \massstiff\ and \massdamp\ can be used as a model for prediction of the frequency of an energy harvesting system.  
