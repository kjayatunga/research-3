...
\subsection{Formulation of the new dimensionless groups suitable to obtain optimum power output \massstiff \ and \massdamp}
\label{sec:newvar}
...
Figure \ref{fig:compare_data} shows the displacement ]amplitude data obtained in figure \ref{fig:compare_data} (a)   
