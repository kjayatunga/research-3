...
%we have defined: \massstiff, \massdamp, and \mstar.
%
%Does \massstiff\ vary for these runs? Yes, but \mstar\ doesn't. So a y-axis variable of $\sqrt(\massstiff)/\massdamp$ would collapse the data just as well. Can you remove the \mstar\ from the y-axis scaling? Do you have data at other \mstar\ that shows you need to include, or potentially shows you can always ignore it?
