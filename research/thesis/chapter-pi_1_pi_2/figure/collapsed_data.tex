...
%      \put(0.495,0.27){\includegraphics[width=0.5\unitlength]{../FnP/gnuplot/velocity_amp_collapsed_re200.eps}}
      ...
      \put(0.08,0.02){\includegraphics[width=0.75\unitlength]{./chapter-pi_1_pi_2/FnP/gnuplot/mean_power_collapsed_parkinson.eps}}
...
%      \put(0.73,0.00){ $\displaystyle\frac{c}{\rho\mathcal{A}U}$}
  ...
  \caption{Dimensionless mean power as a function of \massdamp. Data presented at $\reynoldsnumber=22300$, $\massstiff=200$ ($\times$), $\massstiff=2000$ (\ding{117}) and $\massstiff=10000$ (+). Hysteresis could be observed at high \reynoldsnumber.}
