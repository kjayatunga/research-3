...
\myclearpage
\thispagestyle{plain}
\par\vspace*{.35\textheight}{\centering \emph{``Dedicated to Mrs. Malin Bamunuarachchi whom without this work would not see the light of day. Thank you madam for your prayers, blessings, guidence, kind words of encourgaement and above all, believeing in me and giving me strength to get back up when I myslef have given up hope...."}\par}
...
\input{./chapter-cross-sections/results}
\myclearpage
