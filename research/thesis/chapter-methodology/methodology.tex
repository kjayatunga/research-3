...
These assumptions lead to the Navier-Stokes equations as the equations which govern the motion of a Newtonian, incompressible fluid.
  ...
  $\vcyl$ being the velocity of the body. \accframe, represents acceleration of the body, or $\ddot{y}$.  KASUN: here and throughout - you shouldn't use ``cyl'' to designate the speed and position of your body, since it is not a cylinder. Update the symbol to something like ``b'' or ``body''
