...
The shear layers of the body could be visualised using the magnitude of the strain rate tensor as a high strain rate could be observed in these regions. Instantaneous flow-filed data consists of vortex shedding on top of the shear layers. Hence, the flow-filed data are time averaged over a vortex shedding cycle to filter the vortex shedding (\KJ{Justin is there a way of writing this sentence better}) . 
...
\KJ{Justin I need some help in putting some nice names to these two forces so then the explanation is easier.}   
