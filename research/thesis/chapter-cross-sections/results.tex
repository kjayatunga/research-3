...
In order to investigate further the cause of this negative region, surface pressure data of static DNS simulations were analysed of the isosceles triangle ($\ratio=0$) at $\theta4^{\circ}$, $\theta=16^{\circ}$ and $\theta=21^{\circ}$. Theses points lies in regions where the negative portion increases, the negative portion desecrates and where \cy becomes positive respectively.   
